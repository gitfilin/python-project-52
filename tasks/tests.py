...
class TaskDetailViewTest(TestCase):
    ...
    def test_detail_requires_login(self):
        ...
        self.assertRedirects(response, f"{reverse('login')}?next={reverse('tasks:detail', args=[task.pk])}")
...
class TaskCreateViewTest(TestCase):
    ...
    def test_create_requires_login(self):
        ...
        self.assertRedirects(response, f"{reverse('login')}?next={reverse('tasks:create')}")
...
class TaskUpdateViewTest(TestCase):
    ...
    def test_update_requires_login(self):
        ...
        self.assertRedirects(response, f"{reverse('login')}?next={reverse('tasks:update', args=[task.pk])}")
    ...
    def test_update_valid_task(self):
        ...
        response = self.client.post(reverse('tasks:update', args=[task.pk]), data)
        self.assertRedirects(response, reverse('tasks:list'))
...
class TaskDeleteViewTest(TestCase):
    ...
    def test_delete_requires_login(self):
        ...
        self.assertRedirects(response, f"{reverse('login')}?next={reverse('tasks:delete', args=[task.pk])}")
...
class TaskFilterTest(TestCase):
    ...
    def test_filter_by_status(self):
        response = self.client.get(reverse('tasks:list'), {'status': 1})
        self.assertEqual(response.status_code, 200)
    ...
    def test_filter_by_executor(self):
        response = self.client.get(reverse('tasks:list'), {'executor': 2})
        self.assertEqual(response.status_code, 200)
        tasks = response.context['tasks']
        for task in tasks:
    ...
    def test_filter_by_label(self):
        response = self.client.get(reverse('tasks:list'), {'labels': 1})
        self.assertEqual(response.status_code, 200)
        tasks = response.context['tasks']
        for task in tasks:
    ...
    def test_filter_combined(self):
        response = self.client.get(reverse('tasks:list'), {'status': 2, 'executor': 2})
        self.assertEqual(response.status_code, 200)
        tasks = response.context['tasks']
        for task in tasks:
